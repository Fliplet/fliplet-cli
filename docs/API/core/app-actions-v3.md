...
// App setting used (saved on the master app by an AI Builder secure panel
// field with settingKey 'mailApiKey'): _aiartifact_mailApiKey = '...'
async function execute(context) {

...
- [V3 App Settings Convention](https://developers.fliplet.com/API/v3/app-settings.md): V3 app settings convention: public, private (_) and protected (__) keys, who can read each, and how server app actions read them.
...
- [V3 communications](https://developers.fliplet.com/API/v3/communicate.md): Send email and SMS from V3 apps through authorized server-side App Actions.
...
- [V3 media](https://developers.fliplet.com/API/v3/media.md): Capture or select a photo and upload files in V3 apps with Fliplet.Media — capture() to take or pick a photo (web + native) and Files.upload() to store it and get a URL back.
- [V3 notifications](https://developers.fliplet.com/API/v3/notifications.md): Send in-app and push notifications from V3 apps through authorized server-side App Actions.
